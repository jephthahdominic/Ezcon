  ...
  return (
    <>
      ...
      <main className="font-sans bg-white text-[#2c1c0f]">
        {/* Hero Section */}
        <section 
          className="relative h-[400px] bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] bg-[url('/i-verifyHero.png')] overflow-hidden"
        >
          {/* Tech Background Elements */}
          <div className="absolute inset-0">
            <div className="absolute top-20 left-20 w-32 h-32 bg-blue-500/10 rounded-full blur-xl"></div>
            <div className="absolute top-40 right-32 w-24 h-24 bg-cyan-400/10 rounded-full blur-lg"></div>
            <div className="absolute bottom-20 left-1/3 w-40 h-40 bg-blue-600/10 rounded-full blur-2xl"></div>
