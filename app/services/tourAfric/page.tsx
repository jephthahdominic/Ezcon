  ...
  return (
    <>
      ...
      <main className="font-sans bg-white text-[#2c1c0f]">
        {/* Hero Section */}
        <section 
          className="relative h-[400px] bg-cover bg-center bg-[url('/Hero_img.png')]"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-orange-900/60 via-orange-800/40 to-transparent"></div>
          <div className="relative z-10 h-full flex items-center px-8 md:px-16">
            <div className="max-w-2xl">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">TourAfric</h1>
        ...
        <section className="max-w-6xl mx-auto px-8 pb-16">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="aspect-[4/3] bg-gray-200 rounded-lg overflow-hidden">
              <img src="/Hero_img.png" alt="African Safari" className="w-full h-full object-cover" />
            </div>
            <div className="aspect-[4/3] bg-gray-200 rounded-lg overflow-hidden">
              <img src="/Rectangle 2.png" alt="Coastal Tourism" className="w-full h-full object-cover" />
            </div>
            <div className="aspect-[4/3] bg-gray-200 rounded-lg overflow-hidden">
              <img src="/aboutHero.png" alt="Historical Sites" className="w-full h-full object-cover" />
            </div>
          </div>
        </section>
