  ...
  return (
    <>
      ...
      <main className="font-sans bg-white text-[#2c1c0f]">
        {/* Hero Section */}
        <section 
          className="relative h-[400px] bg-gradient-to-br from-[#0a2540] via-[#1e3a5f] to-[#2d5a87]  overflow-hidden bg-[url('/investAfricHero.png')] bg-cover"
        >
          {/* Background Elements */}
          
          <div className="relative z-10 h-full flex items-center px-8 md:px-16">
            <div className="max-w-2xl">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-3">Invest Africa</h1>
