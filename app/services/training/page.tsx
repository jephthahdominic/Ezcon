  ...
  return (
    <>
      ...
      <main className="font-sans bg-white text-[#2c1c0f]">
        {/* Hero Section */}
        <section className="relative h-[70vh] bg-gradient-to-br from-[#0a1929] via-[#1e293b] to-[#0f172a] bg-[url('/training.png')] overflow-hidden"> 
          <div className="absolute inset-0 bg-black/40"></div>         
          <div className="relative z-10 h-full flex items-end px-8 md:px-16 py-16">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-normal">Training in Fraud Detection & Prevention</h1>
