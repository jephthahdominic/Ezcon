            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <p className="text-sm mb-4 opacity-90">
                  Headquartered in Ghana with presence in the Netherlands and partners 
                  across Africa, Asia, and South America — we are where you need us to be.
                </p>
              ...
              <div>
                ...
                <div className="space-y-1 text-sm">
                  <p>71 Naawe Nkumun Avenue–Accra, Ghana</p>
                  <p>243 Koepelbaan Haarlem-Netherlands</p>
                </div>
              </div>
            </div>
